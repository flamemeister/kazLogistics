      ...
      <div className="bg-white py-16">
        <div className="max-w-6xl mx-auto px-4 md:px-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            ...
            предлагает компания «Great Steppe Logistics». Контейнерная
            перевозка — это способ транспортировки, который подразумевает
            использование стандартизированных грузовых контейнеров. Этот
            подход обеспечивает безопасность груза, ускоряет процесс
            погрузки и разгрузки и гарантирует эффективность грузоперевозок.
          </p>
          ...
          <p className="text-gray-700 leading-relaxed mt-4">
            ...
            спектра товаров. «Great Steppe Logistics» предлагает клиентам
            полный комплекс услуг, связанных с контейнерной перевозкой. Мы
            помогаем с подбором оптимального маршрута, занимаемся
            оформлением всех необходимых документов, а также предлагаем
            услуги погрузки и разгрузки.
          </p>

          <p className="text-gray-700 leading-relaxed mt-4">
            Будучи профессионалами в области логистики, мы знаем, как важно
            соблюдать сроки. Поэтому в «Great Steppe Logistics» мы
