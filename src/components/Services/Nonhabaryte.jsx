            ...
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <p className="text-gray-700">
                  ...
                  и материалы по всему миру, что особенно важно для строительных,
                  энергетических, нефтегазовых и иных крупных проектов.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="bg-white py-16">
        <div className="max-w-6xl mx-auto px-4 md:px-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            ...
            перевозка тяжеловесных грузов, крупного оборудования, техники.
            Опыт и профессионализм, которые мы накопили, позволяют доставлять
            товары вовремя и в идеальном состоянии. Наши специалисты отлично
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            ...
            средство или его комбинация относят к одной из категорий негабаритных
            перевозок. Для каждой категории действуют свои правила, в том числе
            требования к сопровождению (количество пилотов и т. д.) на всём пути.
          </p>
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            ...
            оценки рисков, связанных с перевозкой. Мы детально планируем маршрут,
            составляем график перевозок, готовим план погрузки и разгрузки,
            занимаемся страхованием груза от непредвиденных повреждений.
          </p>
          <p className="text-gray-700 leading-relaxed mb-6">
            В Great Steppe Logistics мы уделяем особое внимание безопасности
            перевозки негабаритных грузов. Это гарантирует высокое качество услуг
            вне зависимости от типа груза или дальности маршрута. Негабаритные
            перевозки особенно востребованы промышленными предприятиями и
            строительными компаниями. Все этапы согласуются с клиентом, чьи
            индивидуальные требования и приоритеты мы учитываем в первую очередь.
            Более подробную информацию о перевозке вашего груза можно получить у
            наших специалистов.
          </p>
        </div>
      </div>
