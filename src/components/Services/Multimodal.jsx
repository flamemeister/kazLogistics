          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <p className="text-gray-700">
                  При помощи разных видов транспорта можно охватить и те
                  районы, где отсутствует, к примеру, железная дорога или морской
                  порт. Это особенно удобно для отдаленных регионов.
                </p>
              </div>
            </div>
            <div className="flex items-start">
      ...
      <div className="bg-white py-16">
        <div className="max-w-6xl mx-auto px-4 md:px-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            ...
            наиболее популярен среди клиентов, так как даёт возможность упростить
            таможенную процедуру и расширить географию доставки.
          </p>
          <p className="text-gray-700 leading-relaxed mb-6">
            Особенностью мультимодальных перевозок является то, что одна
            логистическая компания берёт на себя организацию перевозки и
            несёт ответственность за сохранность товара по договору, оказывая
            комплексные услуги в сфере погрузочно-разгрузочных работ, страхования
            грузов и т.д.
          </p>
          ...
          <ul className="list-decimal list-inside text-gray-700 mt-4 space-y-2">
            <li>
              ...
              Это особенно важно для скоропортящихся продуктов (например,
              при рефрижераторных перевозках).
            </li>
            <li>
            ...
            <li>
              Международные перевозки возможно организовать в любую точку
              мира. Мультимодальный подход позволяет добраться даже на другой
          ...
          <p className="text-gray-700 leading-relaxed mt-6">
            ...
            видов транспорта, чтобы добиться максимально эффективной и
            быстрой доставки.
          </p>
          <p className="text-gray-700 leading-relaxed mt-6">
            Чтобы подобрать оптимальный способ доставки вашего груза,
            свяжитесь с нашими специалистами и получите самое выгодное для вас
            решение!
          </p>
        </div>
      </div>
