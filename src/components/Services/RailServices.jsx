            ...
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <p className="text-gray-700">
                  ...
                  краж. Вагоны обычно закрытого типа, а доступ к ним
      ...
      <div className="bg-white py-16">
        <div className="max-w-6xl mx-auto px-4 md:px-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            ...
            решением, когда нужно перевезти крупногабаритные, тяжеловесные
            грузы или большие партии товаров на дальние расстояния. В Казахстане,
            как и во многих странах, ЖД-транспорт широко используют для перевозки
            ...
            логистических услуг. Компания «Great Steppe Logistics» поможет организовать
            доставку груза железной дорогой или любым другим подходящим видом
            транспорта. Мы, как один из лидеров рынка перевозок в Республике
            Казахстан, гарантируем квалифицированную организацию процесса и
            своевременную доставку вашего груза.
          </p>
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            ...
            международными нормами, которые разрешают перевозить такие грузы
            (в том числе в больших объёмах) более безопасно, чем на некоторых
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            ...
            курсируют только по существующим грузовым железнодорожным
            коридорам, зачастую используется мультимодальный подход — с
            привлечением автотранспорта, чтобы добраться от станции до конечного
            адреса или наоборот.
          </p>
          ...
          <p className="text-gray-700 leading-relaxed">
            Железнодорожные перевозки востребованы, но иногда обходятся
            дороже автомобильных из-за затрат на погрузку, разгрузку и
            обслуживание. Если пункты отправления и назначения не связаны
            напрямую с железнодорожными станциями, нужно организовывать
            мультимодальные перевозки с использованием автотранспорта. Тем не
            менее, при крупных объёмах грузов и больших расстояниях ЖД чаще
            оказывается дешевле благодаря меньшему расходу топлива на тонну
            груза.  
          </p>
