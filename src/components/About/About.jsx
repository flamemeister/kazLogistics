  ...
  return (
    <div>
      ...
      <div className="bg-white py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-600 text-lg leading-relaxed mt-4 text-justify">
            ...
            партнёров за счёт качественного сервиса. Мы стремимся обеспечивать
            высокий уровень надёжности на всех этапах логистической цепочки,
            предлагая профессиональное обслуживание, на которое можно положиться
      ...
      <div className="bg-gray-50 py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-gray-800 mb-4">Наши принципы</h2>
          <div className="mt-2 h-1 w-16 bg-[#0A5225]" />
          <p className="text-gray-600 text-lg leading-relaxed mt-4 text-justify">
            ...
            этапе логистической цепочки мы обеспечиваем профессиональное
            обслуживание, которое гарантирует устойчивый результат даже в самых
            сложных условиях.
          </p>
      ...
      <div className="bg-white py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-600 text-lg leading-relaxed mt-4 text-justify">
            ...
            Благодарим за выбор компании Great Steppe Logistics. Мы высоко ценим
            ваше доверие и с нетерпением ждём плодотворного сотрудничества.
          </p>
        </div>
      </div>
