export default {
  ...
  bannerSubheading: "We deliver cargo to Kazakhstan and Central Asia from any point of the world",
    ...
    form: {
      ...
      comment: "Comment",
      commentPlaceholder: "Describe your question or request...",
      send: "Send",
    ...
    chat: {
      header: "Chat with us",
      initial: "Hi! I'm a bot for Great Steppe Logistics. How can I help you today?",
  ...
  services: {
    ...
    rail: {
      ...
      description:
        "We offer all types of rail transportation, including container and groupage cargo. We ensure fast and safe movement of goods both within the country and abroad."
    },
    road: {
    ...
    outro:
      "Our goal is to provide the best logistics solutions that contribute to the success of your business. Contact us today to discuss your needs and find the best solution!"
  },
  about: {
    title: "ABOUT US",
    company: {
    ...
    mission: {
      heading: "Our mission",
      text:
        "Our mission is to create value in our products for our partners through quality service. We strive to ensure a high level of reliability at all stages of the logistics chain, offering professional service that can be relied on even in the most difficult conditions."
    },
    principles: {
      heading: "Our principles",
      text:
        "The key principles of our work are trust, responsibility and the desire for long‑term cooperation. We build relationships with clients based on mutual respect and transparency, which allows us to become a reliable partner for everyone. An individual approach is central to our work: we carefully study the needs of each client in order to develop solutions that are maximally adapted to their tasks and expectations. High standards of quality and reliability are an integral part of our activities. At every stage of the logistics chain, we provide professional service that guarantees a sustainable result even in the most difficult conditions.",
      items: {
        trust: {
          title: "Trust",
          text:
            "We build relationships with customers based on mutual respect and transparency."
        },
        responsibility: {
          title: "Responsibility",
          text:
            "We guarantee high standards of quality and reliability at every stage of the logistics chain."
        },
        individual: {
          title: "Individual approach",
          text:
            "We study in detail the needs of each client in order to offer the most tailored solutions."
        }
      }
    },
    closing: {
      heading: "Thank you for your choice",
      text1:
        "By following these principles, we do not just provide services, but create value for our partners, helping them achieve their goals.",
      text2:
        "Thank you for choosing Great Steppe Logistics. We highly appreciate your trust and look forward to fruitful cooperation."
    }
  },
  contacts: {
    title: "CONTACTS",
  ...
  auto: {
    ...
    services: {
      heading: "Our road transportation services include:",
      items: {
        1: { prefix: "01", title: "Transportation of full and partial truck loads (LTL, FTL)" },
        2: { prefix: "02", title: "Selection of the best route and transport" },
        3: { prefix: "03", title: "Transportation of heavy, oversized and project cargo" },
        4: { prefix: "04", title: "Transportation of dangerous goods" },
        5: { prefix: "05", title: "Customs clearance" },
        6: { prefix: "06", title: "Regular updates on cargo location and condition" },
      }
    },
    advantages: {
  ...
  avia: {
    ...
    services: {
      heading: "Our air freight services include:",
      items: {
        1: { prefix: "01", title: "Organization of export and import cargo transportation" },
        2: { prefix: "02", title: "International transit and transfer services" },
        3: { prefix: "03", title: "Handling non‑standard cargo: dangerous, valuable, temperature‑sensitive" },
        4: { prefix: "04", title: "Route and aircraft selection" },
        5: { prefix: "05", title: "Customs documentation processing" },
        6: { prefix: "06", title: "Cargo insurance" },
      }
    },
    advantages: {
  ...
  container: {
    ...
    breadcrumb: {
      home: "Home",
      services: "Services",
      current: "Container transportation"
    },
    services: {
      heading: "Our container transportation services include:",
      items: {
        1: { prefix: "01", title: "Transportation of cargo with full and partial container loads (LCL, FCL)" },
        2: { prefix: "02", title: "Selection of the optimal route and transport" },
        3: { prefix: "03", title: "Cargo transport by sea, air, and land" },
        4: { prefix: "04", title: "Transportation of dangerous goods" },
        5: { prefix: "05", title: "Regular updates on cargo location and condition" },
        6: { prefix: "06", title: "Cargo insurance" },
        7: { prefix: "07", title: "Customs documentation processing" }
      }
    },
    advantages: {
  ...
  rail: {
    ...
    services: {
      heading: "Our rail transportation services include:",
      items: {
        1: { prefix: "01", title: "Universal & specialized wagon transport" },
        2: { prefix: "02", title: "Dry, bulk, packaged & liquid cargo" },
        3: { prefix: "03", title: "Oversized & project cargo transport" },
        4: { prefix: "04", title: "Full tracking on all routes" },
        5: { prefix: "05", title: "Provision of wagons" },
        6: { prefix: "06", title: "Customs document processing" },
      }
    },
    advantages: {
  ...
  multimodal: {
    ...
    services: {
      heading: "Our multimodal transportation services include:",
      items: {
        1: { prefix: "01", title: "Optimal route planning & transport selection" },
        2: { prefix: "02", title: "Real‑time cargo location updates" },
        3: { prefix: "03", title: "Customs clearance" },
        4: { prefix: "04", title: "Cargo insurance" }
      }
    },
    advantages: {
  ...
  nonhabaryte: {
    ...
    services: {
      ...
      items: {
        1: { prefix: "01", title: "Planning and coordination" },
        2: { prefix: "02", title: "Route planning & equipment selection" },
        3: { prefix: "03", title: "Permits & licenses procurement" },
        4: { prefix: "04", title: "Packaging & special loading" },
        5: { prefix: "05", title: "Cargo transport to destination" },
        6: { prefix: "06", title: "Real‑time cargo tracking" },
        7: { prefix: "07", title: "Unloading & placement" }
      }
    },
    advantages: {
